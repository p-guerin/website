...
Ember.js 2.2 beta, the branch of Ember that will be released as stable in roughly six weeks, is also be released today.
...
**API docs link required**

This API can be used with previous versions of Ember via the
